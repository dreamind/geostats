/**
 * A wrapper for geostats.js and jenks.util.js
 */
/**
...
var geostats = geostats || null; // global geostats namespace
if (!geostats) {
  geostatsEnclosure();
}

function geostatsEnclosure(){ // start enclosure

// dump of jenks.util.js
